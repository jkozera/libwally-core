{
  "targets": [
    ...
    },
    {
      ...
      "sources": [ "src/aes.c", "src/base58.c", "src/bip38.c", "src/hmac.c", "src/internal.c", "src/pbkdf2.c", "src/ripemd160.c", "src/scrypt.c", "src/secp256k1.c", "src/sha256.c", "src/sha512.c", "src/sign.c", "src/bip32.c" ],
