...
- (void) test_hash{
    ...
    [dict setObject:@[
                      ...
                      @"4f8b42c22dd3729b519ba6f68d2da7cc5b2d606d05daed5ad5128cc03e6c6358"] forKey:@"abc"];
    [cases addObject: dict];
    ...
    [dict setObject:@[
                      ...
                      @"5df6e0e2761359d30a8275058e299fcc0381534545f55cf43e41983f5d4c9456"] forKey:@""];
    [cases addObject: dict];
    ...
    [dict setObject:@[
                      ...
                      @"0cffe17f68954dac3a84fb1458bd5ec99209449749b2b308b7cb55812f9563af"] forKey:@"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq"];
    [cases addObject: dict];
    ...
    [dict setObject:@[
                      ...
                      @"501d289e4900f7e4 331b99dec4b5433a c7d329eeb6dd2654 5e96e55b874be909"] forKey:@"abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmn"];
    [cases addObject: dict];
    ...
    [dict setObject:@[
                      @"cf5b16a7 78af8380 036ce59e 7b049237 0b249b11 e8f07a51 afac4503 7afee9d1",
                      @"8e959b75dae313da 8cf4f72814fc143f 8f7779c6eb9f7fa1 7299aeadb6889018",
                      @"501d289e4900f7e4 331b99dec4b5433a c7d329eeb6dd2654 5e96e55b874be909"] forKey:@"hijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"];
    [cases addObject: dict];
    ...
    [dict setObject:@[
                      ...
                      @"80d1189477563e1b5206b2749f1afe4807e5705e8bd77887a60187a712156688"] forKey:bufStr];
    [cases addObject: dict];

    NSMutableArray *types = [NSMutableArray arrayWithObjects:@"256",@"512",@"160",nil];
    NSMutableArray *aligned = [NSMutableArray arrayWithObjects:@YES,@NO, nil];
